...
export default function CCars() {
  ...
  return (
    <div>
      <h2 align='center' style={{ color: 'white' }}>Car Details </h2>
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
        {cars.map((car, index) => (
          ...
          >
            ...
            <p style={{ color: 'white' }}>Email: {car.email}</p>
            <p style={{ color: 'white' }}>Cost: {car.cost}</p>
            <p style={{ color: 'white' }}>Mileage: {car.milage}</p>
            <p style={{ color: 'white' }}>Type: {car.type}</p>
            <p style={{ color: 'white' }}>Model: {car.model}</p>
            <p style={{ color: 'white' }}>Fuel: {car.fuel}</p>
            <a href="cbookmycar"><button>BUY</button></a>
